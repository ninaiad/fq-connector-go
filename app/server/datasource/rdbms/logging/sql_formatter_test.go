		...
		//nolint:revive
		{
			...
			*/
			...
			selectReq: rdbms_utils.MustTSelectFromLoggerOutput(
				"{\"table\":\"cloud-trail\"}",
				"{\"items\":[{\"column\":{\"name\":\"cluster\", \"type\":{\"optional_type\":{\"item\":{\"type_id\":\"UTF8\"}}}}}, {\"column\":{\"name\":\"json_payload\", \"type\":{\"optional_type\":{\"item\":{\"type_id\":\"JSON\"}}}}}, {\"column\":{\"name\":\"level\", \"type\":{\"optional_type\":{\"item\":{\"type_id\":\"UTF8\"}}}}}, {\"column\":{\"name\":\"message\", \"type\":{\"optional_type\":{\"item\":{\"type_id\":\"UTF8\"}}}}}, {\"column\":{\"name\":\"project\", \"type\":{\"optional_type\":{\"item\":{\"type_id\":\"UTF8\"}}}}}, {\"column\":{\"name\":\"service\", \"type\":{\"optional_type\":{\"item\":{\"type_id\":\"UTF8\"}}}}}, {\"column\":{\"name\":\"timestamp\", \"type\":{\"optional_type\":{\"item\":{\"type_id\":\"TIMESTAMP\"}}}}}]}",
