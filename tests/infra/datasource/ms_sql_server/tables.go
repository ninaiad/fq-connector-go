	...
	"primitives": {
		...
		Schema: &test_utils.TableSchema{
			Columns: map[string]*Ydb.Type{
				...
				"col_17_date":          common.MakeOptionalType(common.MakePrimitiveType(Ydb.Type_DATE)),
				"col_18_smalldatetime": common.MakeOptionalType(common.MakePrimitiveType(Ydb.Type_DATETIME)),
				"col_19_datetime":      common.MakeOptionalType(common.MakePrimitiveType(Ydb.Type_TIMESTAMP)),
				"col_20_datetime2":     common.MakeOptionalType(common.MakePrimitiveType(Ydb.Type_TIMESTAMP)),
			},
		},
		Records: []*test_utils.Record[int32, *array.Int32Builder]{
			{
				Columns: map[string]any{
					...
					"col_17_date": []*uint16{
						...
						nil,
						ptr.Uint16(common.MustTimeToYDBType(common.TimeToYDBDate, time.Date(2023, 03, 21, 0, 0, 0, 0, time.UTC))),
					},
					"col_18_smalldatetime": []*uint32{
						ptr.Uint32(common.MustTimeToYDBType(common.TimeToYDBDatetime,
							time.Date(1988, 11, 20, 12, 55, 00, 0, time.UTC))),
						nil,
						ptr.Uint32(common.MustTimeToYDBType(common.TimeToYDBDatetime,
							time.Date(2023, 03, 21, 11, 21, 00, 0, time.UTC))),
					},
					"col_19_datetime": []*uint64{
						ptr.Uint64(common.MustTimeToYDBType(common.TimeToYDBTimestamp,
							time.Date(1988, 11, 20, 12, 55, 28, 123000000, time.UTC))),
						nil,
						ptr.Uint64(common.MustTimeToYDBType(common.TimeToYDBTimestamp,
		...
		Records: []*test_utils.Record[int32, *array.Int32Builder]{
			{
				Columns: map[string]any{
					...
					"text_column": []*string{ptr.T("a"), ptr.T("b")},
				},
			},
		},
	},
		...
		Records: []*test_utils.Record[int32, *array.Int32Builder]{
			{
				Columns: map[string]any{
					...
					"text_column": []*string{ptr.T("b"), ptr.T("c")},
				},
			},
		},
	},
		...
		Records: []*test_utils.Record[int32, *array.Int32Builder]{
			{
				Columns: map[string]any{
					...
					"text_column": []*string{ptr.T("a"), ptr.T("b"), ptr.T("c")},
				},
			},
		},
	},
		...
		Records: []*test_utils.Record[int32, *array.Int32Builder]{
			{
				Columns: map[string]any{
					...
					"text_column": []*string{ptr.T("b"), ptr.T("c"), nil},
				},
			},
		},
	},
...
func pushdownSchemaYdb() *test_utils.TableSchema {
	return &test_utils.TableSchema{
		Columns: map[string]*Ydb.Type{
			...
			"text_column": common.MakeOptionalType(common.MakePrimitiveType(Ydb.Type_UTF8)),
		},
	}
}
