...
import (
	...
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/clickhouse"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/greenplum"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/mongodb"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/ms_sql_server"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/mysql"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/opensearch"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/oracle"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/postgresql"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/redis"
	"github.com/ninaiad/fq-connector-go/tests/infra/datasource/ydb"
...
func TestOpenSearch(t *testing.T) {
	state.SkipSuiteIfNotEnabled(t)
	testify_suite.Run(t, opensearch.NewSuite(suite.NewBase[string, *array.StringBuilder](t, state, "OpenSearch")))
}
